...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate BM25 PyLucene search.")
    parser.add_argument('project_source_codes_path', type=str, help='Path to the folder containing all software projects')
    parser.add_argument('search_results_storage_path', type=str, help='Path to the search results directory')
    parser.add_argument('evaluation_storage_path', type=str, help='Path to the search evaluation directory for storing results')

    args = parser.parse_args()
    main(args.project_source_codes_path, args.search_results_storage_path, args.evaluation_storage_path)
